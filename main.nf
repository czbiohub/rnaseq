...
process combine_genome_annotation_gzs {
  ...
  input:
  file fastas from genome_fastas.collect()
 ...
 */
if(params.aligner == 'star' && !params.star_index.every() && genome_name){
 ...
 */
if(params.gff && params.gff.size() > 0 && params.gff.every()){
